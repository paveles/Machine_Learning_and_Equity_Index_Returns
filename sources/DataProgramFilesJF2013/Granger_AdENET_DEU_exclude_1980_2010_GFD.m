%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Granger_AdENET_DEU_exclude_1980_2010_GFD.m
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
X_i(:,[2 11])=data_equity_premium_exclude(1:T-1,[2 11]);
...
%    [beta_i tuning_i],'Granger causality--GFD','av19');
%xlswrite('Returns_international_results_1980_2010',...
%    CI_90_i,'Granger causality--GFD','av20');
