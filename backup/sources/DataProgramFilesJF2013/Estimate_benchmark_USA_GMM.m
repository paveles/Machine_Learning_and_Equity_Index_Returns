function [results]=Estimate_benchmark_USA_GMM(Y,X_1,X_2);

% Last modified: 05-16-2012
%
% The function estimates the predictive regression model,
%
% r(i,t+1) = b(i,0) + b(i,1)*x(USA,1,t) + b(i,2)*x(USA,2,t) + e(i,t+1),
%
...
for t=1:(T-1);
    for i=1:N;
        ...
        X_stack((t-1)*N+i,(i-1)*K+1:i*K)=[X_1(t,end) X_2(t,end) 1];
    end;
end;
